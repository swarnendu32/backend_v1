export const captionsData = [
    ...
    "A problem is a chance for you to do your best.The only real mistake is the one from which we learn nothing.",
    ...
    "Mindset is what separates the best from the rest. The best revenge is a massive success.🔥	Your past does not equal your future.",
    ...
    "Life is short. Live it up and live it in the moment. Live for today, plan for tomorrow.",

    "All you can do is all you can do. Make it count. What lies behind us and what lies before us are tiny matters compared to what lies within us.",
    ...
    "If you can't, you must. If you must, you can. The path to success is to take massive, determined action.",
    ...
    "I would never let my best friend do anything stupid…alone bff ❤️",
